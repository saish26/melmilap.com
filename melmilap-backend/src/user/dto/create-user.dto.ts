...
export class CreateUserDto {
  ...
  @ArrayNotEmpty()
  @Type(() => CreateHobbyDto)
  readonly hobby: CreateHobbyDto;

  @IsArray()
  @ValidateNested()
  @ArrayNotEmpty()
  @Type(() => CreateFeatureImageDto)
  readonly feature_image: CreateFeatureImageDto;

  @IsArray()
  @ValidateNested()
  @ArrayNotEmpty()
  @Type(() => CreateSocialLinkDto)
  readonly social_link: CreateSocialLinkDto;

  @IsObject()
  @ValidateNested()
  @IsNotEmptyObject()
  @Type(() => CreateUserDetailDto)
  readonly user_details: CreateUserDetailDto;
